...
public class MainActivity extends AppCompatActivity {
    ...
    private void getWeather(double latitude, double longitude){
        ...
        Call<JsonObject> call =
                retrofitService.getCurrentWeather(latitude, longitude, getString(R.string.weather_app_key));
                    ...
                    if (object != null){
                        ...
                        if (current != null){
                            ...
                            if (temp_feels_like > 30 || (temp_feels_like > 25 && humidity > 60)){
                                ...
                                tv_tip.setText("* 날이 덥고 습하기 때문에 장시간 야외활동은 자제해주세요!");
                            ...
                            WeatherImageUtils.updateWeatherState(mainWeather, iv_weather, tv_weather, day);
